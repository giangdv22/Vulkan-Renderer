...
This mode may result in visible tearing if rendering to the image is not timed correctly.";
		...
		void LogExtent(vk::SurfaceCapabilitiesKHR SurfaceCapabilities)
		{
			...
			std::cout << "\t\twidth: " << SurfaceCapabilities.currentExtent.width << "\n";
			std::cout << "\t\twidth: " << SurfaceCapabilities.currentExtent.height << "\n";

			std::cout << "\tmin supported extent: \n";
			std::cout << "\t\twidth: " << SurfaceCapabilities.minImageExtent.width << "\n";
			std::cout << "\t\theight: " << SurfaceCapabilities.minImageExtent.height << "\n";

			std::cout << "\t max supported extent: \n";
			std::cout << "\t\twidth: " << SurfaceCapabilities.maxImageExtent.width << "\n";
			std::cout << "\t\theight: " << SurfaceCapabilities.maxImageExtent.height << "\n";
